...
- Deploy directly from the bundle instead of standalone helmrelease.
- Cleanup values and helm template functions.
...
[Unreleased]: https://github.com/giantswarm/aws-nth-bundle/compare/v1.4.0...HEAD
[1.4.0]: https://github.com/giantswarm/aws-nth-bundle/compare/v1.3.0...v1.4.0
